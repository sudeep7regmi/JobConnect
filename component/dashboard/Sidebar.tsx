  ...
  return (
    <aside className="w-72 min-h-screen bg-[#0f172a] text-white flex flex-col">
      ...
      <div className="p-8 border-b border-gray-800">
        <h1 className="text-3xl font-bold text-blue-400">JobConnect</h1>

        <p className="text-gray-400 text-sm mt-2">Professional Dashboard</p>
      </div>
      ...
      <div className="p-6 border-t border-gray-800">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="font-semibold">Sudeep</h2>
